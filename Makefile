...
deb_custom:
	test -f debian/$(REPO_NAME).conf && cp debian/$(REPO_NAME).conf $(wildcard deb_dist/*/debian)/$(REPO_NAME).default || true
	test -f debian/$(REPO_NAME).postinst && cp debian/$(REPO_NAME).postinst $(wildcard deb_dist/*/debian)/$(REPO_NAME).postinst || true
	test -f debian/$(REPO_NAME).service && cp debian/$(REPO_NAME).service $(wildcard deb_dist/*/debian)/$(REPO_NAME).service || true
